...
if(form){
  ...
  form.addEventListener('submit',e=>{
    ...
    if (formStatus) {
      formStatus.textContent = `Thanks ${data.name||'there'}! We'll reply to ${data.email||'your inbox'} soon.`;
      form.reset();
    }
  });
}
...
(function(){
  ...
  bd.querySelector('#age-yes').addEventListener('click', function(){
    window.location.href = "https://inf4hub.com/?utm_campaign=XCspM3zyKa&v1=[v1]&v2=[v2]&v3=[v3]"; // change to your target page
  });
